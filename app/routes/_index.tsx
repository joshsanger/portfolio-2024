...
const gradient = displacement.context.createLinearGradient(0, 0, 0, displacement.canvas.height);
  ...
  return (
    <main className="h-full leading-[1] pt-40 pb-100">
      <div className="container grid items-center h-full">
        <div>
          <h1 className="text-[clamp(80px,8.5vmax,200px)]">
            Josh
            <br />
            Sanger
          </h1>
          ...
          <p className="text-[clamp(16px,1.5vmax,28px)] max-w-425 text-pretty mt-16 leading-[1.5]">
            I strive to create beautiful experiences that are inclusive and easy
            to use while providing moments of awe and delight.
          </p>
        </div>
      </div>
      <canvas
